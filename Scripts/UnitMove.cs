...
namespace RedBjorn.ProtoTiles.Example
{
    public class UnitMove : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (MyInput.GetOnWorldUp && Range != 0)
            {
                HandleWorldClick();
            }
            PathUpdate();
        ...
        IEnumerator waitBeforeCamera()
        {
            yield return new WaitForSeconds(4);
            
            GameController.playerMoveFinished = true;
        ...
        void onMovingStopped()
        {
            Range = 0;
            AreaShow();
            StartCoroutine("waitBeforeCamera");
        }
